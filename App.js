          ...
          <ScrollView contentContainerStyle={{ padding: 14, paddingBottom: 110 }}>
            ...
            {bottomNav === 'Invite' && (
              <View style={{ backgroundColor: 'rgba(27, 38, 59, 0.92)', borderRadius: 14, padding: 14 }}>
                ...
                <Text style={{ color: '#fff', fontSize: 14, fontWeight: 'bold', marginVertical: 6 }}>Invite Friends & Earn 30% Commission</Text>
                <Text style={{ color: '#94a3b8', fontSize: 12, marginBottom: 8 }}>Apne referral link ko dosto ke saath share karein aur unke recharge par 30% direct commission paayein:</Text>
                <View style={{ backgroundColor: '#1e293b', padding: 10, borderRadius: 8, borderWidth: 1, borderColor: '#334155', marginBottom: 12 }}>
                  <Text style={{ color: '#22c55e', fontWeight: 'bold', fontSize: 12 }}>{refLink}</Text>
                </View>
                <TouchableOpacity style={{ backgroundColor: '#16a34a', padding: 12, borderRadius: 10, alignItems: 'center', marginBottom: 10 }} onPress={() => Share.share({ message: `☀️ Join Solar Invest and start daily earning! Use my referral link: ${refLink}` })}>
            ...
            {bottomNav === 'Profile' && (
              <View style={{ backgroundColor: 'rgba(27, 38, 59, 0.92)', borderRadius: 14, padding: 14 }}>
                ...
                <TouchableOpacity style={{ backgroundColor: '#f59e0b', padding: 12, borderRadius: 10, alignItems: 'center', marginBottom: 8 }} onPress={() => setAdminModalVisible(true)}>
                  <Text style={{ color: '#000', fontWeight: 'bold' }}>👑 Owner / Admin Panel (Pending: {depositRequests.length + withdrawRequests.length})</Text>
                </TouchableOpacity>

                <TouchableOpacity style={{ backgroundColor: '#0284c7', padding: 11, borderRadius: 10, alignItems: 'center' }} onPress={openSupport}>
                  <Text style={{ color: '#fff', fontWeight: 'bold' }}>✈️ 24/7 Official Support (@Guri7412)</Text>
                </TouchableOpacity>
              </View>
            )}
          </ScrollView>
        ...
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.85)', justifyContent: 'center', alignItems: 'center', padding: 16 }}>
          <View style={{ backgroundColor: '#fff', borderRadius: 18, padding: 16, width: '100%', maxWidth: 360 }}>
            ...
            <View style={{ alignItems: 'center', marginVertical: 6, backgroundColor: '#f8fafc', padding: 8, borderRadius: 10, borderWidth: 1, borderColor: '#e2e8f0' }}>
              <Image source={{ uri: `https://api.qrserver.com/v1/create-qr-code/?size=140x140&data=upi://
